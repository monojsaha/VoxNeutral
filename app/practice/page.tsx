...
const SEGMENTS: Segment[] = [
  {
    ...
    duration: 2,
    description: "Phonemes that challenge Bengali speakers most",
    wordKeys: ["vulnerability", "algorithm", "artificial", "generative", "governance", "throughput", "retrieval"],
  ...
  },
  {
    ...
    title: "AI & Agentic AI",
    duration: 3,
    description: "Core vocabulary for AI leadership conversations",
    wordKeys: ["agentic", "generative", "inference", "embeddings", "hallucination", "multimodal", "reinforcement", "tokenization"],
  ...
  },
  {
    ...
    duration: 3,
    description: "Stress patterns in architecture and engineering terms",
    wordKeys: ["orchestration", "authentication", "containerization", "microservices", "kubernetes", "infrastructure", "encapsulation", "polymorphism"],
    color: "text-brand-500",
  },
  {
    id: "integration-api",
    ...
    duration: 2,
    description: "Words every solution architect must pronounce precisely",
    wordKeys: ["middleware", "serialization", "synchronization", "idempotency", "versioning", "federation", "protocol", "payload"],
    color: "text-warning-500",
  },
  {
    id: "consulting-sales",
    title: "Consulting & Presales",
    duration: 2,
    description: "Revenue and client-facing executive vocabulary",
    wordKeys: ["differentiation", "proposition", "qualification", "procurement", "commercialization", "articulation", "demonstration", "negotiation"],
  ...
  },
  {
    ...
    duration: 2,
    description: "Consulting and architecture leadership terms",
    wordKeys: ["rationalization", "consolidation", "benchmarking", "remediation", "methodology", "deliverable", "stakeholder", "taxonomy"],
    color: "text-warning-500",
  },
  {
    id: "review",
    title: "Review — Executive Essentials",
    duration: 2,
    description: "High-frequency words in boardroom and client settings",
    wordKeys: ["interoperability", "observability", "transformation", "modernization", "scalability", "availability", "reliability", "resilience"],
